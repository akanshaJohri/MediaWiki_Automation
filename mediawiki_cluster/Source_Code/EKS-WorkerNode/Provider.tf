...
//Local backend storage path
    path = "../../Tfstate_file/EKS-WorkerNode/terraform.tfstate"
  }
}

##=======================================================##
##############Data Source from IAM State File##############
##=======================================================##
...
data "terraform_remote_state" "iam_tfst" {
  ...
  config = {
//Data Source of EKS Cluster tfstate file
...
##===============================================================##
##############Data Source from EKS Cluster State File##############
##===============================================================##
